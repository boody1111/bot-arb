...
async function simsimi(a, b, c) {
  ...
  try {
      ...
      if (j && j.message) return { error: !1, data: { success: j.message } };
      return { error: !0, data: {} };
  } catch (p) {
      try {
        var { data: k } = await d({ url: `https://simsimi.fun/api/v2/?mode=talk&lang=ar&message=${g(a)}&filter=true`, method: "GET" });
        return { error: !1, data: k };
      } catch (e) {
        return { error: !0, data: {} };
      }
  }
